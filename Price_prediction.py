...
# com = ["Poultry cuts & offal, except livers, fresh or chilled"]
# cat = "02_meat_and_edible_meat_offal"

# commodity = label_encoder.fit_transform(com)
# print(commodity)
...
# # distance = input("Enter the distance from India: ")
